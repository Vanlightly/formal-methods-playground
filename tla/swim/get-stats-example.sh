...
--behaviours $BEHAVIOURS --dimension1 members --output_dir $RAW_OUTPUT_DIR/dead_v2_pg1 --workers $WORKERS --members 3-4 --dead 1 \
--new 0 --initial_contact 0 --peer_group_size 1 --suspect_timeout 0 --disseminations 4 --max_updates 6 --lose_every_nth 0 \
--force_to_round 0

python3 -u calculate_stats.py --raw_output_dir $RAW_OUTPUT_DIR/dead_v2_pg1 --analysis_dir $ANALYSIS_OUTPUT_DIR